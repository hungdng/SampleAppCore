    ...
    function registerEvents() {
        ...
        $('#btnSave').on('click', function (e) {
            if ($('#frmMaintainance').valid()) {
                ...
                $.ajax({
                    ...
                    success: function (response) {
                        sampleCore.notify('Update role successful', 'success');
                    ...
                    error: function () {
                        sampleCore.notify('Has an error', 'error');
                        sampleCore.stopLoading();
                    }
                });
                return false;
        ...
        $('body').on('click', '.btn-delete', function (e) {
            ...
            sampleCore.confirm('Are you sure to delete?', function () {
                $.ajax({
                    ...
                    error: function (status) {
                        sampleCore.notify('Has an error in deleting progress', 'error');
                        sampleCore.stopLoading();
                    }
                });
            });
        ...
        $("#btnSavePermission").off('click').on('click', function () {
            ...
            $.ajax({
                ...
                data: {
                    listPermission: listPermmission,
                    roleId: $('#hidRoleId').val()
                },
                beforeSend: function () {
                    sampleCore.startLoading();
                ...
                success: function (response) {
                    sampleCore.notify('Save permission successful', 'success');
                    $('#modal-grantpermission').modal('hide');
                    sampleCore.stopLoading();
                },
                error: function () {
                    sampleCore.notify('Has an error in save permission progress', 'error');
                    sampleCore.stopLoading();
                }
            });
        });
