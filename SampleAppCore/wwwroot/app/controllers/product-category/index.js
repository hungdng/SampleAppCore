        ...
        $('body').on('click', '#btnDelete', function (e) {
            ...
            sampleCore.confirm('Are you sure to delete?', function () {
                $.ajax({
                    ...
                    success: function (response) {
                        sampleCore.notify('Deleted success', 'success');
                        sampleCore.stopLoading();
                        loadData();
                    },
                    error: function (status) {
        ...
        $('#btnSave').on('click', function (e) {
            if ($('#frmMaintainance').valid()) {
                ...
                $.ajax({
                    ...
                    success: function (response) {
                        sampleCore.notify('Update success', 'success');
                    ...
                    error: function () {
                        sampleCore.notify('Has an error in update progress', 'error');
                        sampleCore.stopLoading();
                    }
                });
            }
    ...
    function loadData() {
        $.ajax({
            ...
            success: function (response) {
                ...
                var treeArr = sampleCore.unflattern(data);
